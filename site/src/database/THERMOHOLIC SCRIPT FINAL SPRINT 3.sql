...
CREATE TABLE if not exists Empresa (
	...
	QtdTanques INT -- Quantidade de tanques de fermentação na empresa (o update da informação será feito após a reunião de acordo com o cliente, por isso essa informação não terá que ser preenchida na aba de cadastro)
);
...
(null, 'Gyulia Martins Piqueira', 'gyulia.piqueira@sptech.school', '11975536244', '075.675.234-00', 'Gyulia06', 1),
(null, 'Natalia Russo', 'natalia.russo@sptech.school', '11913653449', '234.567.235-09', 'Nat029', 2),
(null, 'Isabel Bermudes', 'isabel.bermudes@sptech.school', '11944556244', '607.845.623-60', 'Isabel12', 3),
(null, 'Alexandre Murata', 'alexandre.murata@sptech.school', '11975533333', '142.456.834-90', 'Alex1', 4),
(null, 'Luiz Adorno', 'luiz.adorno@sptech.school', '11975534455', '000.023.012-91', 'Luiz0901',  4),
(null, 'Brudney Ramos', 'brudney.ramosjr@sptech.school', '11975532366', '923.534.890-96', sha2('Brudney2', 256), 2);
...
tanque.nomeReceita as 'Nome da Receita', 
tanque.tempMax as 'Temperatura Máxima Aceitável', 
tanque.tempMin as 'Temperatura Mínima Aceitável', 
sensor.salaSensor as 'Sala do Sensor', 
leitura.TemperaturaTanque as 'Temperatura Atual', 
usuario.nome as 'Nome do Usuário', 
usuario.email as 'Email do Usuário', 
empresa.nome as 'Nome da Empresa'
 FROM Tanque JOIN Sensor ON idSensor = fkSensorT 
 JOIN Leitura ON idSensor = fkSensorL 
 JOIN Empresa ON idEmpresa = fkEmpresaT 
 JOIN Usuario ON idEmpresa = fkEmpresaU; 
