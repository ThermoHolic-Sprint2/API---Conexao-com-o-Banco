function AtualizarKPI() {
    ...
    if (temperatura1 < 0 || temperatura1 > 15) {
        alerta1.innerHTML = 'Taque 1 - Super em alerta';
        ...
        alerta1.innerHTML = 'Taque 1- Em alerta';
    ...
    if (temperatura2 <= 1 || temperatura2 >= 30) {
        alerta2.innerHTML = 'Taque 2 - Super em alerta';
        ...
        alerta2.innerHTML = 'Taque 2 - Em alerta';
    ...
    if (temperatura3 < 0 || temperatura3 > 15) {
        alerta3.innerHTML = 'Taque 3 - Super em alerta';
        ...
        alerta3.innerHTML = 'Taque 3 - Em alerta';
    ...
    if (altemperatura4e4 <= 1 || temperatura4 >= 30) {
        alerta4.innerHTML = 'Taque 4 - Super em alerta';
        ...
        alerta4.innerHTML = 'Taque 4 - Em alerta';
